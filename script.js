...
function displayCustomer(){
      ...
      <div class="card card-user" style="width: 10rem; ">
        ...
        <div class="card-body">
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item"><span>Belanjaan</span>: ${item.keranjang.map((barang)=> barang.nama)}</li>
            <li class="list-group-item"><span>Total Harga</span>: ${item.total}</li>
            
          </ul>
          <div class="btn-container"> 
          <button type="button" class="btn btn-outline-success" onclick="saveEdit(${index})" data-bs-toggle="modal" data-bs-target="#exampleModal">Edit</button>
  ...
  costumer[index].alamat = alamatEdit;
   ...
   return rowCostumer.innerHTML +=  cardCustomer
  }
